...
- `runtime/host`: host lifecycle, manifest loading, app worker supervision, and managed function execution.
...
- `discovery`: route, event, and function discovery plus manifest generation.
